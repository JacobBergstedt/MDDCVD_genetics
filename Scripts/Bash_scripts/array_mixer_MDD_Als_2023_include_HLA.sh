...
mdd_path="Data/Sumstats_mixer_with_HLA/MDD_Als_2023_sumstats"
mdd_fit_out="Results/Mixer/MDD_Als_2023_include_HLA/MDD_Als_2023.fit.${REP}"
mdd_param="${mdd_fit_out}.json"
mdd_test_out="Results/Mixer/MDD_Als_2023_include_HLA/MDD_Als_2023.test.${REP}"
...
trait_path="Data/Sumstats_mixer_with_HLA/""${input}""_sumstats"
trait_fit_out="Results/Mixer/MDD_Als_2023_include_HLA/""${input}"".fit.${REP}"
trait_param="${trait_fit_out}.json"
trait_test_out="Results/Mixer/MDD_Als_2023_include_HLA/""${input}"".test.${REP}"
mdd_trait_fit_out="Results/Mixer/MDD_Als_2023_include_HLA/MDD_vs_""${input}"".fit.${REP}"
mdd_trait_param="${mdd_trait_fit_out}.json"
mdd_trait_test_out="Results/Mixer/MDD_Als_2023_include_HLA/MDD_vs_""${input}"".test.${REP}"
