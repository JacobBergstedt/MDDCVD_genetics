...
#SBATCH --output=Slurm/Output/Mixer_plot_no_HLA.out
#SBATCH --error=Slurm/Error/Mixer_plot_no_HLA.out
...
for input in AF CAD_2022 HF_2019_V2 PAD
do

echo $input
$PYTHON /tools/mixer/precimed/mixer_figures.py combine --json Results/Mixer/MDD_Als_2023/MDD_vs_${input}.test.rep@.json  --out Results/Mixer/MDD_Als_2023/Combined/MDD_vs_${input}.test.combined
$PYTHON /tools/mixer/precimed/mixer_figures.py combine --json Results/Mixer/MDD_Als_2023/MDD_vs_${input}.fit.rep@.json  --out Results/Mixer/MDD_Als_2023/Combined/MDD_vs_${input}.fit.combined

$PYTHON /tools/mixer/precimed/mixer_figures.py two \
    --json-test Results/Mixer/MDD_Als_2023/Combined/MDD_vs_${input}.test.combined.json \
    --json-fit Results/Mixer/MDD_Als_2023/Combined/MDD_vs_${input}.fit.combined.json \
    --out Results/Mixer/MDD_Als_2023/Output/MDD_vs_${input}.output \
    --statistic mean std

$PYTHON /tools/mixer/precimed/mixer_figures.py two \
    --json Results/Mixer/MDD_Als_2023/MDD_vs_${input}.test.rep*.json \
    --out Results/Mixer/MDD_Als_2023/Output/MDD_vs_${input}.test.repeats.output

$PYTHON /tools/mixer/precimed/mixer_figures.py two \
    --json Results/Mixer/MDD_Als_2023/MDD_vs_${input}.fit.rep*.json \
    --out Results/Mixer/MDD_Als_2023/Output/MDD_vs_${input}.fit.repeats.output
