...
if (idx_split == 1) {
  ...
  write.table(keys, file = "./Data/TMP_data/input_info_file1.txt", quote = FALSE)
  
}

input <- process.input(input.info.file = "./Data/TMP_data/input_info_file1.txt",
...
write_tsv(res_uni, paste0("./Results/Chunk_data/LAVA_Als_2023/LAVA_uni_", target_trait, "_",  idx_split, ".tsv"))
write_tsv(res_biv, paste0("./Results/Chunk_data/LAVA_Als_2023/LAVA_biv_", target_trait, "_", idx_split, ".tsv"))
