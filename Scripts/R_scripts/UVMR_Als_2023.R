...
write_tsv(res, "Results/MR/MDD_Als_2023/UVMR_results.tsv")
write_tsv(pleiotropy, "Results/MR/MDD_Als_2023/UVMR_pleiotropy.tsv")
write_tsv(heterogeneity, "Results/MR/MDD_Als_2023/UVMR_heterogeneity.tsv")

write_tsv(res, paste0(Sys.getenv("export"), "/UVMR_results_Als_2023.tsv"))
write_tsv(pleiotropy, paste0(Sys.getenv("export"), "/pleiotropy_Als_2023.tsv"))
write_tsv(heterogeneity, paste0(Sys.getenv("export"), "/heterogeneity_Als_2023.tsv"))
